        ...
        {loading ? (
          ...
          <div className="py-10 min-h-[80vh]">
            ...
            <div className="flex flex-wrap gap-3.5">
             ...
             overflow-hidden hover:border-indigo-800/80
             transition-all duration-300"
                >
                  ...
                  {/* Content */}
                  <div className="px-4 py-6 text-white bg-linear-180 from-transparent group-hover:from-indigo-950 to-transparent transition-colors">
